...
func (m *mockArgoClient) NewWorkflowServiceClient() workflow.WorkflowServiceClient {
	return m.workflowServiceClient
}
...
func (m *mockArgoClient) NewCronWorkflowServiceClient() (cronworkflow.CronWorkflowServiceClient, error) {
	return nil, errors.New("not implemented")
}
...
func (m *mockArgoClient) NewClusterWorkflowTemplateServiceClient() (clusterworkflowtemplate.ClusterWorkflowTemplateServiceClient, error) {
	return nil, errors.New("not implemented")
}

func (m *mockArgoClient) NewInfoServiceClient() (info.InfoServiceClient, error) {
	return nil, errors.New("not implemented")
}
